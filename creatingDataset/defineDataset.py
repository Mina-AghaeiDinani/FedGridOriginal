from creatingDataset.splittingData import *
...
#%%
def defineTrainset(dataset,n_step_in,n_step_out,n_features, minTime, maxTime, granularity, lag, latNumScaled, lngNumScaled,timeClm, minSize):
    ...
    for step in range(0,granularity,lag): 
        ...
        df_lat1 = (df1.iloc[step::granularity,latNumScaled])
        df_lng1 = (df1.iloc[step::granularity,lngNumScaled])  
    ...
    if (len(df2) > minSize):
        for step in range(0,granularity,lag):
             ...
             #....create train set of one car,put all information of that specific car in list............................................................................................
            df_lat2 = (df2.iloc[step::granularity,latNumScaled]) 
            df_lng2 = (df2.iloc[step::granularity,lngNumScaled]) 
            # define input sequence
...
#%%
def defineShortTestset(dataset,n_step_in,n_step_out,n_features,granularity,latNumScaled,lngNumScaled):
    X,y = list(), list()
    #....create train set of one car,put all information of that specific car in list.
    df_lat1 = (dataset.iloc[::granularity,latNumScaled]) #Scaled lat, every 5 seconds
    df_lng1 = (dataset.iloc[::granularity,lngNumScaled])  #Scaled lng
    ...
    return array(X),array(y)
#%%
def defineValidationset(dataset,n_step_in,n_step_out,n_features, minTime, maxTime, granularity, lag, latNumScaled, lngNumScaled,timeClm, minSize):
